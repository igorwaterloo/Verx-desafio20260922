    ...
    public partial class Inicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChavesIdempotencia", x => new { x.TenantId, x.Chave });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LancamentoOriginalId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Lancamentos", x => new { x.TenantId, x.Id });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PlanoCodigo = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    LimiteLancamentosMes = table.Column<int>(type: "int", nullable: false),
                    AtualizadoEm = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantsPlanos", x => x.TenantId);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lancamentos_TenantId_CriadoEm",
                table: "Lancamentos",
                columns: new[] { "TenantId", "CriadoEm" });

            migrationBuilder.CreateIndex(
                name: "IX_Lancamentos_TenantId_DataCompetencia",
                table: "Lancamentos",
                columns: new[] { "TenantId", "DataCompetencia" });

            migrationBuilder.CreateIndex(
                name: "IX_Lancamentos_TenantId_LancamentoOriginalId",
                table: "Lancamentos",
                columns: new[] { "TenantId", "LancamentoOriginalId" },
                unique: true,
                filter: "[LancamentoOriginalId] IS NOT NULL");
