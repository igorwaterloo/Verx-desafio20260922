...
/// <summary>
/// Resultado de uma operação que pode falhar de forma esperada (Result pattern).
/// </summary>
public class Result
{
...
/// <summary>
/// Resultado com valor. Acessar <see cref="Value"/> em uma falha é erro de programação.
/// </summary>
public sealed class Result<TValue> : Result
{
    ...
    public TValue Value => IsSuccess
        ? _value!
        : throw new InvalidOperationException($"Não é possível acessar o valor de um resultado com falha ({Error.Code}).");
